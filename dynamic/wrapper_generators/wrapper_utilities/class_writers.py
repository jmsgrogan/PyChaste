...
import methods_writers
import constructor_writers
...
class PyChasteCppClassWrapperWriter(CppClassWrapperWriter):

    def __init__(self, *args, **kwargs):
        CppClassWrapperWriter.__init__(self, *args, **kwargs)

        self.exclusion_args = ["::Vec", "::Mat"]
        self.smart_ptr_handle = "boost::shared_ptr"
