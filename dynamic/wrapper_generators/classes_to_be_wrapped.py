...
cell_based_cell_property_classes = [
                    CppClass('AbstractCellProperty', excluded_methods=["IsType"], include_vec_ptr_self=True),
                      ...
                      CppClass('AbstractCellProliferativeType'), 
                      CppClass('StemCellProliferativeType'),
                      CppClass('DefaultCellProliferativeType'), 
                      CppClass('TransitCellProliferativeType'),
                      CppClass('DifferentiatedCellProliferativeType'), 
                      CppClass('AbstractCellMutationState'),
                      CppClass('ApcOneHitCellMutationState'), 
                      CppClass('ApcTwoHitCellMutationState'),
                      CppClass('BetaCateninOneHitCellMutationState'), 
                      CppClass('WildTypeCellMutationState'),
                      CppClass('ApoptoticCellProperty'), 
                      CppClass('CellData'),
                      CppClass('CellLabel'), 
                      CppClass('CellAncestor'),
                      CppClass('CellId'), 
                      CppClass('CellPropertyRegistry', excluded_methods=["rGetAllCellProperties",
                                                                    "TakeOwnership",
                                                                    "Get"]),]
