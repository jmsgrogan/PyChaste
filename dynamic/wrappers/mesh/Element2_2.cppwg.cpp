...
py::class_<Element2_2 , Element2_2_Overloads   >(m, "Element2_2")
        .def(py::init<unsigned int, ::std::vector<Node<2> *, std::allocator<Node<2> *> > const &, bool >(), py::arg("index"), py::arg("rNodes"), py::arg("registerWithNodes") = true)
