...
void register_AbstractMesh2_2_class(py::module &m){
    py::class_<AbstractMesh2_2, AbstractMesh2_2_Overloads, std::shared_ptr<AbstractMesh2_2 >  >(m, "AbstractMesh2_2")
        ...
        .def("Translate", (void (AbstractMesh2_2::*)(double const, double const, double const)) &AbstractMesh2_2::Translate, "" , py::arg("xMovement") = 0., py::arg("yMovement") = 0., py::arg("zMovement") = 0.)
        .def("Rotate", (void (AbstractMesh2_2::*)(::boost::numeric::ublas::c_matrix<double, 2, 2>)) &AbstractMesh2_2::Rotate, "" , py::arg("rotationMatrix"))
        .def("Rotate", (void (AbstractMesh2_2::*)(::boost::numeric::ublas::c_vector<double, 3>, double)) &AbstractMesh2_2::Rotate, "" , py::arg("axis"), py::arg("angle"))
        .def("RotateX", (void (AbstractMesh2_2::*)(double const)) &AbstractMesh2_2::RotateX, "" , py::arg("theta"))
        .def("RotateY", (void (AbstractMesh2_2::*)(double const)) &AbstractMesh2_2::RotateY, "" , py::arg("theta"))
