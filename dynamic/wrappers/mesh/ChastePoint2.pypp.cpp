...
void register_ChastePoint2_class(py::module &m){
    py::class_<ChastePoint2, std::shared_ptr<ChastePoint2 >  >(m, "ChastePoint2")
        ...
        .def("rGetLocation", (::boost::numeric::ublas::c_vector<double, 2> const & (ChastePoint2::*)() const ) &ChastePoint2::rGetLocation, "" )
        .def("GetWithDefault", (double (ChastePoint2::*)(unsigned int, double) const ) &ChastePoint2::GetWithDefault, "" , py::arg("i"), py::arg("def") = 0.)
        .def("SetCoordinate", (void (ChastePoint2::*)(unsigned int, double)) &ChastePoint2::SetCoordinate, "" , py::arg("i"), py::arg("value"))
        .def("IsSamePoint", (bool (ChastePoint2::*)(::ChastePoint<2> const &) const ) &ChastePoint2::IsSamePoint, "" , py::arg("rPoint"))
    ;
}
