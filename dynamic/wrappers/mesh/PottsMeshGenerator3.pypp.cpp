...
class PottsMeshGenerator3_Overloads : public PottsMeshGenerator3{
    public:
    using PottsMeshGenerator3::SharedPottsMeshGenerator<3>;

        ::boost::shared_ptr<PottsMesh<3> > GetMesh() override {
        PYBIND11_OVERLOAD(
        ::boost::shared_ptr<PottsMesh<3> >,
        PottsMeshGenerator3,
        GetMesh,
...
void register_PottsMeshGenerator3_class(py::module &m){
    py::class_<PottsMeshGenerator3, PottsMeshGenerator3_Overloads, std::shared_ptr<PottsMeshGenerator3 >  >(m, "PottsMeshGenerator3")
        ...
        .def(py::init< >())
        .def("GetMesh", (::boost::shared_ptr<PottsMesh<3> > (PottsMeshGenerator3::*)()) &PottsMeshGenerator3::GetMesh, "" )
    ;
}
