...
void register_Node3_class(py::module &m){
    py::class_<Node3, std::shared_ptr<Node3 >  >(m, "Node3")
        ...
        .def("GetPoint", (::ChastePoint<3> (Node3::*)()) &Node3::GetPoint, "" )
        .def("rGetLocation", (::boost::numeric::ublas::c_vector<double, 3> const & (Node3::*)()) &Node3::rGetLocation, "" )
        .def("rGetModifiableLocation", (::boost::numeric::ublas::c_vector<double, 3> & (Node3::*)()) &Node3::rGetModifiableLocation, "" )
        .def("GetIndex", (unsigned int (Node3::*)()) &Node3::GetIndex, "" )
        .def("IsBoundaryNode", (bool (Node3::*)()) &Node3::IsBoundaryNode, "" )
        ...
        .def("GetNumContainingElements", (unsigned int (Node3::*)()) &Node3::GetNumContainingElements, "" )
        .def("GetNumBoundaryElements", (unsigned int (Node3::*)()) &Node3::GetNumBoundaryElements, "" )
        ...
        .def("IsDeleted", (bool (Node3::*)()) &Node3::IsDeleted, "" )
        .def("MarkAsInternal", (void (Node3::*)()) &Node3::MarkAsInternal, "" )
        .def("IsInternal", (bool (Node3::*)()) &Node3::IsInternal, "" )
        .def("SetRegion", (void (Node3::*)(unsigned int)) &Node3::SetRegion, "" , py::arg("region"))
        .def("GetRegion", (unsigned int (Node3::*)()) &Node3::GetRegion, "" )
        .def("ContainingElementsBegin", (::Node<3>::ContainingElementIterator (Node3::*)()) &Node3::ContainingElementsBegin, "" )
        .def("ContainingElementsEnd", (::Node<3>::ContainingElementIterator (Node3::*)()) &Node3::ContainingElementsEnd, "" )
        .def("ContainingBoundaryElementsBegin", (::Node<3>::ContainingBoundaryElementIterator (Node3::*)()) &Node3::ContainingBoundaryElementsBegin, "" )
        .def("ContainingBoundaryElementsEnd", (::Node<3>::ContainingBoundaryElementIterator (Node3::*)()) &Node3::ContainingBoundaryElementsEnd, "" )
    ;
}
