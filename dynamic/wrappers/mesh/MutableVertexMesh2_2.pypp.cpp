...
void register_MutableVertexMesh2_2_class(py::module &m){
    py::class_<MutableVertexMesh2_2, MutableVertexMesh2_2_Overloads, std::shared_ptr<MutableVertexMesh2_2 >  >(m, "MutableVertexMesh2_2")
        ...
        .def(py::init< >())
        .def("SetCellRearrangementThreshold", (void (MutableVertexMesh2_2::*)(double)) &MutableVertexMesh2_2::SetCellRearrangementThreshold, "" , py::arg("cellRearrangementThreshold"))
        .def("SetT2Threshold", (void (MutableVertexMesh2_2::*)(double)) &MutableVertexMesh2_2::SetT2Threshold, "" , py::arg("t2Threshold"))
        .def("SetCellRearrangementRatio", (void (MutableVertexMesh2_2::*)(double)) &MutableVertexMesh2_2::SetCellRearrangementRatio, "" , py::arg("cellRearrangementRatio"))
        .def("SetProtorosetteFormationProbability", (void (MutableVertexMesh2_2::*)(double)) &MutableVertexMesh2_2::SetProtorosetteFormationProbability, "" , py::arg("protorosetteFormationProbability"))
        .def("SetProtorosetteResolutionProbabilityPerTimestep", (void (MutableVertexMesh2_2::*)(double)) &MutableVertexMesh2_2::SetProtorosetteResolutionProbabilityPerTimestep, "" , py::arg("protorosetteResolutionProbabilityPerTimestep"))
        ...
        .def("ClearLocationsOfT1Swaps", (void (MutableVertexMesh2_2::*)()) &MutableVertexMesh2_2::ClearLocationsOfT1Swaps, "" )
        .def("ClearLocationsOfT3Swaps", (void (MutableVertexMesh2_2::*)()) &MutableVertexMesh2_2::ClearLocationsOfT3Swaps, "" )
        .def("AddNode", (unsigned int (MutableVertexMesh2_2::*)(::Node<2> *)) &MutableVertexMesh2_2::AddNode, "" , py::arg("pNewNode"))
        .def("DeleteElementPriorToReMesh", (void (MutableVertexMesh2_2::*)(unsigned int)) &MutableVertexMesh2_2::DeleteElementPriorToReMesh, "" , py::arg("index"))
        .def("DeleteNodePriorToReMesh", (void (MutableVertexMesh2_2::*)(unsigned int)) &MutableVertexMesh2_2::DeleteNodePriorToReMesh, "" , py::arg("index"))
        .def("DivideElementAlongShortAxis", (unsigned int (MutableVertexMesh2_2::*)(::VertexElement<2, 2> *, bool)) &MutableVertexMesh2_2::DivideElementAlongShortAxis, "" , py::arg("pElement"), py::arg("placeOriginalElementBelow") = false)
        .def("DivideElementAlongGivenAxis", (unsigned int (MutableVertexMesh2_2::*)(::VertexElement<2, 2> *, ::boost::numeric::ublas::c_vector<double, 2>, bool)) &MutableVertexMesh2_2::DivideElementAlongGivenAxis, "" , py::arg("pElement"), py::arg("axisOfDivision"), py::arg("placeOriginalElementBelow") = false)
        .def("AddElement", (unsigned int (MutableVertexMesh2_2::*)(::VertexElement<2, 2> *)) &MutableVertexMesh2_2::AddElement, "" , py::arg("pNewElement"))
        .def("CheckForT2Swaps", (bool (MutableVertexMesh2_2::*)(::VertexElementMap &)) &MutableVertexMesh2_2::CheckForT2Swaps, "" , py::arg("rElementMap"))
        .def("Clear", (void (MutableVertexMesh2_2::*)()) &MutableVertexMesh2_2::Clear, "" )
        .def("DivideEdge", (void (MutableVertexMesh2_2::*)(::Node<2> *, ::Node<2> *)) &MutableVertexMesh2_2::DivideEdge, "" , py::arg("pNodeA"), py::arg("pNodeB"))
        .def("RemoveDeletedNodesAndElements", (void (MutableVertexMesh2_2::*)(::VertexElementMap &)) &MutableVertexMesh2_2::RemoveDeletedNodesAndElements, "" , py::arg("rElementMap"))
        .def("RemoveDeletedNodes", (void (MutableVertexMesh2_2::*)()) &MutableVertexMesh2_2::RemoveDeletedNodes, "" )
        .def("ReMesh", (void (MutableVertexMesh2_2::*)(::VertexElementMap &)) &MutableVertexMesh2_2::ReMesh, "" , py::arg("rElementMap"))
        .def("ReMesh", (void (MutableVertexMesh2_2::*)()) &MutableVertexMesh2_2::ReMesh, "" )
    ;
}
