...
void register_MutableMesh3_3_class(py::module &m){
    py::class_<MutableMesh3_3, MutableMesh3_3_Overloads, std::shared_ptr<MutableMesh3_3 >  >(m, "MutableMesh3_3")
        .def(py::init< >())
        ...
        .def("MoveMergeNode", (void (MutableMesh3_3::*)(unsigned int, unsigned int, bool)) &MutableMesh3_3::MoveMergeNode, "" , py::arg("index"), py::arg("targetIndex"), py::arg("concreteMove") = true)
        .def("DeleteNode", (void (MutableMesh3_3::*)(unsigned int)) &MutableMesh3_3::DeleteNode, "" , py::arg("index"))
        .def("DeleteElement", (void (MutableMesh3_3::*)(unsigned int)) &MutableMesh3_3::DeleteElement, "" , py::arg("index"))
        .def("DeleteNodePriorToReMesh", (void (MutableMesh3_3::*)(unsigned int)) &MutableMesh3_3::DeleteNodePriorToReMesh, "" , py::arg("index"))
        .def("RefineElement", (unsigned int (MutableMesh3_3::*)(::Element<3, 3> *, ::ChastePoint<3>)) &MutableMesh3_3::RefineElement, "" , py::arg("pElement"), py::arg("point"))
        .def("DeleteBoundaryNodeAt", (void (MutableMesh3_3::*)(unsigned int)) &MutableMesh3_3::DeleteBoundaryNodeAt, "" , py::arg("index"))
        .def("ReIndex", (void (MutableMesh3_3::*)(::NodeMap &)) &MutableMesh3_3::ReIndex, "" , py::arg("map"))
        .def("ReMesh", (void (MutableMesh3_3::*)(::NodeMap &)) &MutableMesh3_3::ReMesh, "" , py::arg("map"))
        .def("ReMesh", (void (MutableMesh3_3::*)()) &MutableMesh3_3::ReMesh, "" )
        .def("SplitEdge", (::boost::numeric::ublas::c_vector<unsigned int, 3> (MutableMesh3_3::*)(::Node<3> *, ::Node<3> *)) &MutableMesh3_3::SplitEdge, "" , py::arg("pNodeA"), py::arg("pNodeB"))
        .def("CheckIsVoronoi", (bool (MutableMesh3_3::*)(double)) &MutableMesh3_3::CheckIsVoronoi, "" , py::arg("maxPenetration") = 0.)
    ;
}
