...
void register_FileFinder_class(py::module &m){
    py::class_<FileFinder, FileFinder_Overloads, std::shared_ptr<FileFinder >  >(m, "FileFinder")
        .def(py::init< >())
        .def(py::init<::std::string const &, ::RelativeTo::Value >())
        .def(py::init<::std::string const &, ::FileFinder const & >())
        ...
        .def_static("FakePath", (void (*)(::RelativeTo::Value, ::std::string const &)) &FileFinder::FakePath, "" , py::arg("fakeWhat"), py::arg("rFakePath"))
        .def_static("StopFaking", (void (*)()) &FileFinder::StopFaking, "" )
    ;
}
