...
void register_TimeStepper_class(py::module &m){
    py::class_<TimeStepper, std::shared_ptr<TimeStepper >  >(m, "TimeStepper")
        ...
        .def("GetTime", (double (TimeStepper::*)() const ) &TimeStepper::GetTime, "" )
        .def("GetNextTime", (double (TimeStepper::*)() const ) &TimeStepper::GetNextTime, "" )
        ...
        .def("IsTimeAtEnd", (bool (TimeStepper::*)() const ) &TimeStepper::IsTimeAtEnd, "" )
        .def("EstimateTimeSteps", (unsigned int (TimeStepper::*)() const ) &TimeStepper::EstimateTimeSteps, "" )
        .def("GetTotalTimeStepsTaken", (unsigned int (TimeStepper::*)() const ) &TimeStepper::GetTotalTimeStepsTaken, "" )
