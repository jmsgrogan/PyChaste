...
py::class_<SimpleOxygenBasedCellCycleModel , SimpleOxygenBasedCellCycleModel_Overloads  , AbstractSimplePhaseBasedCellCycleModel  >(m, "SimpleOxygenBasedCellCycleModel")
        .def(py::init< >())
        .def(
            "UpdateCellCyclePhase", 
