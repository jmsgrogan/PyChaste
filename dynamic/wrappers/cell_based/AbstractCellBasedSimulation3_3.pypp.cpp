...
py::class_<AbstractCellBasedSimulation3_3 , AbstractCellBasedSimulation3_3_Overloads , boost::shared_ptr<AbstractCellBasedSimulation3_3 >  , Identifiable  >(m, "AbstractCellBasedSimulation3_3")
        .def(
            "GetNodeLocation", 
