...
void register_CellPropertyCollection_class(py::module &m){
    py::class_<CellPropertyCollection, std::shared_ptr<CellPropertyCollection >  >(m, "CellPropertyCollection")
        ...
        .def("HasProperty", (bool (CellPropertyCollection::*)(::boost::shared_ptr<AbstractCellProperty> const &) const ) &CellPropertyCollection::HasProperty, "" , py::arg("rProp"))
        ...
        .def("GetSize", (unsigned int (CellPropertyCollection::*)() const ) &CellPropertyCollection::GetSize, "" )
        ...
        .def("GetProperty", (::boost::shared_ptr<AbstractCellProperty> (CellPropertyCollection::*)() const ) &CellPropertyCollection::GetProperty, "" )
    ;
}
