...
py::class_<AbstractCellBasedSimulation2_2 , AbstractCellBasedSimulation2_2_Overloads , boost::shared_ptr<AbstractCellBasedSimulation2_2 >  , Identifiable  >(m, "AbstractCellBasedSimulation2_2")
        .def(
            "GetNodeLocation", 
