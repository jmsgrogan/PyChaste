...
void register_SurfaceAreaConstraintPottsUpdateRule2_class(py::module &m){
    py::class_<SurfaceAreaConstraintPottsUpdateRule2, SurfaceAreaConstraintPottsUpdateRule2_Overloads, std::shared_ptr<SurfaceAreaConstraintPottsUpdateRule2 >  >(m, "SurfaceAreaConstraintPottsUpdateRule2")
        .def(py::init< >())
