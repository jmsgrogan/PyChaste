...
py::class_<CellsGeneratorNoCellCycleModel_3  , boost::shared_ptr<CellsGeneratorNoCellCycleModel_3 >   >(m, "CellsGeneratorNoCellCycleModel_3")
        ...
        .def(
            "GenerateBasic", 
            (void(CellsGeneratorNoCellCycleModel_3::*)(::std::vector<boost::shared_ptr<Cell>, std::allocator<boost::shared_ptr<Cell> > > &, unsigned int, ::std::vector<unsigned int, std::allocator<unsigned int> > const, ::boost::shared_ptr<AbstractCellProperty>)) &CellsGeneratorNoCellCycleModel_3::GenerateBasic, 
        ...
        .def(
            "GenerateBasicRandom", 
            (void(CellsGeneratorNoCellCycleModel_3::*)(::std::vector<boost::shared_ptr<Cell>, std::allocator<boost::shared_ptr<Cell> > > &, unsigned int, ::boost::shared_ptr<AbstractCellProperty>)) &CellsGeneratorNoCellCycleModel_3::GenerateBasicRandom, 
        ...
        .def(
            ...
            (void(CellsGeneratorNoCellCycleModel_3::*)(::std::vector<boost::shared_ptr<Cell>, std::allocator<boost::shared_ptr<Cell> > > &, ::std::vector<unsigned int, std::allocator<unsigned int> > const, ::boost::shared_ptr<AbstractCellProperty>)) &CellsGeneratorNoCellCycleModel_3::GenerateGivenLocationIndices, 
