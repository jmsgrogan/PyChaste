...
void register_AttractingPlaneBoundaryCondition2_2_class(py::module &m){
    py::class_<AttractingPlaneBoundaryCondition2_2, AttractingPlaneBoundaryCondition2_2_Overloads, std::shared_ptr<AttractingPlaneBoundaryCondition2_2 >  >(m, "AttractingPlaneBoundaryCondition2_2")
        ...
        .def("VerifyBoundaryCondition", (bool (AttractingPlaneBoundaryCondition2_2::*)()) &AttractingPlaneBoundaryCondition2_2::VerifyBoundaryCondition, "" )
        .def("OutputCellPopulationBoundaryConditionParameters", (void (AttractingPlaneBoundaryCondition2_2::*)(::out_stream &)) &AttractingPlaneBoundaryCondition2_2::OutputCellPopulationBoundaryConditionParameters, "" , py::arg("rParamsFile"))
        .def("SetPointOnPlane", (void (AttractingPlaneBoundaryCondition2_2::*)(::boost::numeric::ublas::c_vector<double, 2> const &)) &AttractingPlaneBoundaryCondition2_2::SetPointOnPlane, "" , py::arg("rPoint"))
        .def("SetAttractionThreshold", (void (AttractingPlaneBoundaryCondition2_2::*)(double)) &AttractingPlaneBoundaryCondition2_2::SetAttractionThreshold, "" , py::arg("attractionThreshold"))
    ;
}
