...
void register_PlaneBoundaryCondition2_2_class(py::module &m){
    py::class_<PlaneBoundaryCondition2_2, PlaneBoundaryCondition2_2_Overloads, std::shared_ptr<PlaneBoundaryCondition2_2 >  >(m, "PlaneBoundaryCondition2_2")
        ...
        .def("rGetPointOnPlane", (::boost::numeric::ublas::c_vector<double, 2> const & (PlaneBoundaryCondition2_2::*)() const ) &PlaneBoundaryCondition2_2::rGetPointOnPlane, "" )
        .def("rGetNormalToPlane", (::boost::numeric::ublas::c_vector<double, 2> const & (PlaneBoundaryCondition2_2::*)() const ) &PlaneBoundaryCondition2_2::rGetNormalToPlane, "" )
