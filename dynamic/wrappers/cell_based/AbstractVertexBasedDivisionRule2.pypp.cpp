...
py::class_<AbstractVertexBasedDivisionRule2 , AbstractVertexBasedDivisionRule2_Overloads , boost::shared_ptr<AbstractVertexBasedDivisionRule2 >  , Identifiable  >(m, "AbstractVertexBasedDivisionRule2")
        .def(
            "CalculateCellDivisionVector", 
