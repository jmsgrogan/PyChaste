...
py::class_<AbstractCellPopulation3_3 , AbstractCellPopulation3_3_Overloads , boost::shared_ptr<AbstractCellPopulation3_3 >  , Identifiable  >(m, "AbstractCellPopulation3_3")
        .def(
            "InitialiseCells", 
