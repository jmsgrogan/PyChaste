...
py::class_<AbstractCellPopulationBoundaryCondition2_2 , AbstractCellPopulationBoundaryCondition2_2_Overloads   >(m, "AbstractCellPopulationBoundaryCondition2_2")
        .def(
            "ImposeBoundaryCondition", 
