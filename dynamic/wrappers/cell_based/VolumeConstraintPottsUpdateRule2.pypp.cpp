...
void register_VolumeConstraintPottsUpdateRule2_class(py::module &m){
    py::class_<VolumeConstraintPottsUpdateRule2, VolumeConstraintPottsUpdateRule2_Overloads, std::shared_ptr<VolumeConstraintPottsUpdateRule2 >  >(m, "VolumeConstraintPottsUpdateRule2")
        .def(py::init< >())
