...
void register_AbstractPhaseBasedCellCycleModel_class(py::module &m){
    py::class_<AbstractPhaseBasedCellCycleModel, AbstractPhaseBasedCellCycleModel_Overloads, std::shared_ptr<AbstractPhaseBasedCellCycleModel > , AbstractCellCycleModel  >(m, "AbstractPhaseBasedCellCycleModel")
        ...
        .def("SetG2Duration", (void (AbstractPhaseBasedCellCycleModel::*)(double)) &AbstractPhaseBasedCellCycleModel::SetG2Duration, "" , py::arg("g2Duration"))
