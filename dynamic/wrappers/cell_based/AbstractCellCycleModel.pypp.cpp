...
void register_AbstractCellCycleModel_class(py::module &m){
    py::class_<AbstractCellCycleModel, AbstractCellCycleModel_Overloads, std::shared_ptr<AbstractCellCycleModel > , Identifiable  >(m, "AbstractCellCycleModel")
        .def("SetCell", (void (AbstractCellCycleModel::*)(::CellPtr)) &AbstractCellCycleModel::SetCell, "" , py::arg("pCell"))
        .def("Initialise", (void (AbstractCellCycleModel::*)()) &AbstractCellCycleModel::Initialise, "" )
        .def("InitialiseDaughterCell", (void (AbstractCellCycleModel::*)()) &AbstractCellCycleModel::InitialiseDaughterCell, "" )
        ...
        .def("CreateCellCycleModel", (::AbstractCellCycleModel * (AbstractCellCycleModel::*)()) &AbstractCellCycleModel::CreateCellCycleModel, "" )
        .def("CanCellTerminallyDifferentiate", (bool (AbstractCellCycleModel::*)()) &AbstractCellCycleModel::CanCellTerminallyDifferentiate, "" )
        .def("GetAverageTransitCellCycleTime", (double (AbstractCellCycleModel::*)()) &AbstractCellCycleModel::GetAverageTransitCellCycleTime, "" )
        .def("GetAverageStemCellCycleTime", (double (AbstractCellCycleModel::*)()) &AbstractCellCycleModel::GetAverageStemCellCycleTime, "" )
        .def("OutputCellCycleModelInfo", (void (AbstractCellCycleModel::*)(::out_stream &)) &AbstractCellCycleModel::OutputCellCycleModelInfo, "" , py::arg("rParamsFile"))
        .def("OutputCellCycleModelParameters", (void (AbstractCellCycleModel::*)(::out_stream &)) &AbstractCellCycleModel::OutputCellCycleModelParameters, "" , py::arg("rParamsFile"))
    ;
}
