...
void register_AbstractCellProperty_class(py::module &m){
    py::class_<AbstractCellProperty, boost::shared_ptr<AbstractCellProperty > , Identifiable  >(m, "AbstractCellProperty")
        .def(py::init< >())
        .def("IsSame", (bool (AbstractCellProperty::*)(::AbstractCellProperty const *) const ) &AbstractCellProperty::IsSame, "" , py::arg("pOther"))
        .def("IsSame", (bool (AbstractCellProperty::*)(::boost::shared_ptr<const AbstractCellProperty>) const ) &AbstractCellProperty::IsSame, "" , py::arg("pOther"))
        ...
        .def("GetCellCount", (unsigned int (AbstractCellProperty::*)() const ) &AbstractCellProperty::GetCellCount, "" )
    ;
}
