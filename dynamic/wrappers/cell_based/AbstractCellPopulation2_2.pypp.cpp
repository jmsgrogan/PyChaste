...
py::class_<AbstractCellPopulation2_2 , AbstractCellPopulation2_2_Overloads , boost::shared_ptr<AbstractCellPopulation2_2 >  , Identifiable  >(m, "AbstractCellPopulation2_2")
        .def(
            "InitialiseCells", 
