...
void register_CellData_class(py::module &m){
    py::class_<CellData, std::shared_ptr<CellData > , AbstractCellProperty  >(m, "CellData")
        ...
        .def("GetItem", (double (CellData::*)(::std::string const &)) &CellData::GetItem, "" , py::arg("rVariableName"))
        .def("GetNumItems", (unsigned int (CellData::*)()) &CellData::GetNumItems, "" )
        .def("GetKeys", (::std::vector<std::basic_string<char>, std::allocator<std::basic_string<char> > > (CellData::*)()) &CellData::GetKeys, "" )
    ;
}
