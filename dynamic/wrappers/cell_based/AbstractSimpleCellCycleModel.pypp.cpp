...
void register_AbstractSimpleCellCycleModel_class(py::module &m){
    py::class_<AbstractSimpleCellCycleModel, AbstractSimpleCellCycleModel_Overloads, std::shared_ptr<AbstractSimpleCellCycleModel > , AbstractCellCycleModel  >(m, "AbstractSimpleCellCycleModel")
        .def("ReadyToDivide", (bool (AbstractSimpleCellCycleModel::*)()) &AbstractSimpleCellCycleModel::ReadyToDivide, "" )
        .def("ResetForDivision", (void (AbstractSimpleCellCycleModel::*)()) &AbstractSimpleCellCycleModel::ResetForDivision, "" )
