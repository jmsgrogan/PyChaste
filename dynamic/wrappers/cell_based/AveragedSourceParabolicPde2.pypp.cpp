...
py::class_<AveragedSourceParabolicPde2 , AveragedSourceParabolicPde2_Overloads , boost::shared_ptr<AveragedSourceParabolicPde2 >   >(m, "AveragedSourceParabolicPde2")
        ...
        .def(
            "SetupSourceTerms", 
            (void(AveragedSourceParabolicPde2::*)(::TetrahedralMesh<2, 2> &, ::std::map<boost::shared_ptr<Cell>, unsigned int, std::less<boost::shared_ptr<Cell> >, std::allocator<std::pair<const boost::shared_ptr<Cell>, unsigned int> > > *)) &AveragedSourceParabolicPde2::SetupSourceTerms, 
