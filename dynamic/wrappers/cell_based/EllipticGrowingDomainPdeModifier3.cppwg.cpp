...
py::class_<EllipticGrowingDomainPdeModifier3 , EllipticGrowingDomainPdeModifier3_Overloads , boost::shared_ptr<EllipticGrowingDomainPdeModifier3 >  , AbstractGrowingDomainPdeModifier<3>  >(m, "EllipticGrowingDomainPdeModifier3")
        .def(py::init<::boost::shared_ptr<AbstractLinearPde<3, 3> >, ::boost::shared_ptr<AbstractBoundaryCondition<3> >, bool, ::Vec >(), py::arg("pPde") = boost::shared_ptr<AbstractLinearPde<DIM, DIM> >(), py::arg("pBoundaryCondition") = boost::shared_ptr<AbstractBoundaryCondition<DIM> >(), py::arg("isNeumannBoundaryCondition") = true, py::arg("solution") = nullptr)
        .def(
            "UpdateAtEndOfTimeStep", 
