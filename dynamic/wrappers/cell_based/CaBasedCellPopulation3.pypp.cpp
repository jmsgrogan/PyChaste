...
void register_CaBasedCellPopulation3_class(py::module &m){
    py::class_<CaBasedCellPopulation3, CaBasedCellPopulation3_Overloads, std::shared_ptr<CaBasedCellPopulation3 >  >(m, "CaBasedCellPopulation3")
        .def(py::init<::PottsMesh<3> &, ::std::vector<boost::shared_ptr<Cell>, std::allocator<boost::shared_ptr<Cell> > > &, ::std::vector<unsigned int, std::allocator<unsigned int> > const, unsigned int, bool, bool >())
        .def(py::init<::PottsMesh<3> & >())
        .def("IsSiteAvailable", (bool (CaBasedCellPopulation3::*)(unsigned int, ::CellPtr)) &CaBasedCellPopulation3::IsSiteAvailable, "" , py::arg("index"), py::arg("pCell"))
        .def("GetTetrahedralMeshForPdeModifier", (::TetrahedralMesh<3, 3> * (CaBasedCellPopulation3::*)()) &CaBasedCellPopulation3::GetTetrahedralMeshForPdeModifier, "" )
        .def("GetNode", (::Node<3> * (CaBasedCellPopulation3::*)(unsigned int)) &CaBasedCellPopulation3::GetNode, "" , py::arg("index"))
        .def("GetNumNodes", (unsigned int (CaBasedCellPopulation3::*)()) &CaBasedCellPopulation3::GetNumNodes, "" )
        .def("GetNeighbouringLocationIndices", (::std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > (CaBasedCellPopulation3::*)(::CellPtr)) &CaBasedCellPopulation3::GetNeighbouringLocationIndices, "" , py::arg("pCell"))
        .def("GetLocationOfCellCentre", (::boost::numeric::ublas::c_vector<double, 3> (CaBasedCellPopulation3::*)(::CellPtr)) &CaBasedCellPopulation3::GetLocationOfCellCentre, "" , py::arg("pCell"))
        .def("AddCellUsingLocationIndex", (void (CaBasedCellPopulation3::*)(unsigned int, ::CellPtr)) &CaBasedCellPopulation3::AddCellUsingLocationIndex, "" , py::arg("index"), py::arg("pCell"))
        .def("RemoveCellUsingLocationIndex", (void (CaBasedCellPopulation3::*)(unsigned int, ::CellPtr)) &CaBasedCellPopulation3::RemoveCellUsingLocationIndex, "" , py::arg("index"), py::arg("pCell"))
        .def("GetNodeCorrespondingToCell", (::Node<3> * (CaBasedCellPopulation3::*)(::CellPtr)) &CaBasedCellPopulation3::GetNodeCorrespondingToCell, "" , py::arg("pCell"))
        .def("AddCell", (::CellPtr (CaBasedCellPopulation3::*)(::CellPtr, ::CellPtr)) &CaBasedCellPopulation3::AddCell, "" , py::arg("pNewCell"), py::arg("pParentCell") = ::CellPtr( ))
        .def("EvaluateDivisionPropensity", (double (CaBasedCellPopulation3::*)(unsigned int, unsigned int, ::CellPtr)) &CaBasedCellPopulation3::EvaluateDivisionPropensity, "" , py::arg("currentNodeIndex"), py::arg("targetNodeIndex"), py::arg("pCell"))
        .def("RemoveDeadCells", (unsigned int (CaBasedCellPopulation3::*)()) &CaBasedCellPopulation3::RemoveDeadCells, "" )
        .def("OpenWritersFiles", (void (CaBasedCellPopulation3::*)(::OutputFileHandler &)) &CaBasedCellPopulation3::OpenWritersFiles, "" , py::arg("rOutputFileHandler"))
        .def("UpdateCellLocations", (void (CaBasedCellPopulation3::*)(double)) &CaBasedCellPopulation3::UpdateCellLocations, "" , py::arg("dt"))
        .def("IsCellAssociatedWithADeletedLocation", (bool (CaBasedCellPopulation3::*)(::CellPtr)) &CaBasedCellPopulation3::IsCellAssociatedWithADeletedLocation, "" , py::arg("pCell"))
        .def("Update", (void (CaBasedCellPopulation3::*)(bool)) &CaBasedCellPopulation3::Update, "" , py::arg("hasHadBirthsOrDeaths") = true)
        .def("AcceptPopulationWriter", (void (CaBasedCellPopulation3::*)(::boost::shared_ptr<AbstractCellPopulationWriter<3, 3> >)) &CaBasedCellPopulation3::AcceptPopulationWriter, "" , py::arg("pPopulationWriter"))
        .def("AcceptPopulationCountWriter", (void (CaBasedCellPopulation3::*)(::boost::shared_ptr<AbstractCellPopulationCountWriter<3, 3> >)) &CaBasedCellPopulation3::AcceptPopulationCountWriter, "" , py::arg("pPopulationCountWriter"))
        .def("AcceptCellWriter", (void (CaBasedCellPopulation3::*)(::boost::shared_ptr<AbstractCellWriter<3, 3> >, ::CellPtr)) &CaBasedCellPopulation3::AcceptCellWriter, "" , py::arg("pCellWriter"), py::arg("pCell"))
        .def("GetVolumeOfCell", (double (CaBasedCellPopulation3::*)(::CellPtr)) &CaBasedCellPopulation3::GetVolumeOfCell, "" , py::arg("pCell"))
        .def("GetWidth", (double (CaBasedCellPopulation3::*)(unsigned int const &)) &CaBasedCellPopulation3::GetWidth, "" , py::arg("rDimension"))
        .def("RemoveAllUpdateRules", (void (CaBasedCellPopulation3::*)()) &CaBasedCellPopulation3::RemoveAllUpdateRules, "" )
        .def("OutputCellPopulationParameters", (void (CaBasedCellPopulation3::*)(::out_stream &)) &CaBasedCellPopulation3::OutputCellPopulationParameters, "" , py::arg("rParamsFile"))
        .def("IsRoomToDivide", (bool (CaBasedCellPopulation3::*)(::CellPtr)) &CaBasedCellPopulation3::IsRoomToDivide, "" , py::arg("pCell"))
