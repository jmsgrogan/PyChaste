...
void register_SimulationTime_class(py::module &m){
    py::class_<SimulationTime, std::shared_ptr<SimulationTime >  >(m, "SimulationTime")
        ...
        .def("GetTimeStep", (double (SimulationTime::*)()) &SimulationTime::GetTimeStep, "" )
        .def("IncrementTimeOneStep", (void (SimulationTime::*)()) &SimulationTime::IncrementTimeOneStep, "" )
        .def("GetTimeStepsElapsed", (unsigned int (SimulationTime::*)()) &SimulationTime::GetTimeStepsElapsed, "" )
        .def("GetTime", (double (SimulationTime::*)()) &SimulationTime::GetTime, "" )
        .def_static("Destroy", (void (*)()) &SimulationTime::Destroy, "" )
        .def("IsStartTimeSetUp", (bool (SimulationTime::*)()) &SimulationTime::IsStartTimeSetUp, "" )
        .def("IsEndTimeAndNumberOfTimeStepsSetUp", (bool (SimulationTime::*)()) &SimulationTime::IsEndTimeAndNumberOfTimeStepsSetUp, "" )
        .def("IsFinished", (bool (SimulationTime::*)()) &SimulationTime::IsFinished, "" )
