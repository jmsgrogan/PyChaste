...
py::class_<AveragedSourceParabolicPde3 , AveragedSourceParabolicPde3_Overloads , boost::shared_ptr<AveragedSourceParabolicPde3 >   >(m, "AveragedSourceParabolicPde3")
        ...
        .def(
            "SetupSourceTerms", 
            (void(AveragedSourceParabolicPde3::*)(::TetrahedralMesh<3, 3> &, ::std::map<boost::shared_ptr<Cell>, unsigned int, std::less<boost::shared_ptr<Cell> >, std::allocator<std::pair<const boost::shared_ptr<Cell>, unsigned int> > > *)) &AveragedSourceParabolicPde3::SetupSourceTerms, 
