...
void register_OffLatticeSimulation3_3_class(py::module &m){
    py::class_<OffLatticeSimulation3_3, OffLatticeSimulation3_3_Overloads, std::shared_ptr<OffLatticeSimulation3_3 >  >(m, "OffLatticeSimulation3_3")
        .def(py::init<::AbstractCellPopulation<3, 3> &, bool, bool >())
        .def("AddForce", (void (OffLatticeSimulation3_3::*)(::boost::shared_ptr<AbstractForce<3, 3> >)) &OffLatticeSimulation3_3::AddForce, "" , py::arg("pForce"))
        .def("RemoveAllForces", (void (OffLatticeSimulation3_3::*)()) &OffLatticeSimulation3_3::RemoveAllForces, "" )
