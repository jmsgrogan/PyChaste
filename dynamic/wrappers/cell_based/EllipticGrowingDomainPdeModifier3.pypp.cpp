...
void register_EllipticGrowingDomainPdeModifier3_class(py::module &m){
    py::class_<EllipticGrowingDomainPdeModifier3, EllipticGrowingDomainPdeModifier3_Overloads, std::shared_ptr<EllipticGrowingDomainPdeModifier3 >  >(m, "EllipticGrowingDomainPdeModifier3")
        .def("UpdateAtEndOfTimeStep", (void (EllipticGrowingDomainPdeModifier3::*)(::AbstractCellPopulation<3, 3> &)) &EllipticGrowingDomainPdeModifier3::UpdateAtEndOfTimeStep, "" , py::arg("rCellPopulation"))
        .def("SetupSolve", (void (EllipticGrowingDomainPdeModifier3::*)(::AbstractCellPopulation<3, 3> &, ::std::string)) &EllipticGrowingDomainPdeModifier3::SetupSolve, "" , py::arg("rCellPopulation"), py::arg("outputDirectory"))
        .def("OutputSimulationModifierParameters", (void (EllipticGrowingDomainPdeModifier3::*)(::out_stream &)) &EllipticGrowingDomainPdeModifier3::OutputSimulationModifierParameters, "" , py::arg("rParamsFile"))
    ;
}
