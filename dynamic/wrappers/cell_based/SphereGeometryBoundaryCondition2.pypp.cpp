...
class SphereGeometryBoundaryCondition2_Overloads : public SphereGeometryBoundaryCondition2{
    public:
    using SphereGeometryBoundaryCondition2::SphereGeometryBoundaryCondition<2>;
...
void register_SphereGeometryBoundaryCondition2_class(py::module &m){
    py::class_<SphereGeometryBoundaryCondition2, SphereGeometryBoundaryCondition2_Overloads, std::shared_ptr<SphereGeometryBoundaryCondition2 >  >(m, "SphereGeometryBoundaryCondition2")
        ...
        .def("rGetCentreOfSphere", (::boost::numeric::ublas::c_vector<double, 2> const & (SphereGeometryBoundaryCondition2::*)()) &SphereGeometryBoundaryCondition2::rGetCentreOfSphere, "" )
        .def("GetRadiusOfSphere", (double (SphereGeometryBoundaryCondition2::*)()) &SphereGeometryBoundaryCondition2::GetRadiusOfSphere, "" )
