...
py::class_<AbstractCellPopulationBoundaryCondition3_3 , AbstractCellPopulationBoundaryCondition3_3_Overloads   >(m, "AbstractCellPopulationBoundaryCondition3_3")
        .def(
            "ImposeBoundaryCondition", 
